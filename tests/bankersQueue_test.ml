...
let tests_from_list = "test suite for from_list" >::: [
  "empty, checking front"        >::         (fun _ -> assert_equal 0
                                                                    (from_list []).frontSize);
...
(*  "only rear"             >::          (fun _ -> assert_equal {front = [3; 2; 1]; frontSize = 3; rear = []; rearSize = 0}*)
(*                                                              (check {front = []; frontSize = 0; rear = [1; 2; 3;]; rearSize = 3}));*)
(*  "equal size"            >::          (fun _ -> assert_equal {front = [3; 2; 1]; frontSize = 3; rear = [4; 5; 6]; rearSize = 3}*)
(*                                                              (check {front = [3; 2; 1]; frontSize = 3; rear = [4; 5; 6]; rearSize = 3}));*)
(*  "front larger"          >::          (fun _ -> assert_equal {front = [3; 2; 1; 0]; frontSize = 4; rear = [4; 5; 6]; rearSize = 3}*)
(*                                                              (check {front = [3; 2; 1; 0]; frontSize = 4; rear = [4; 5; 6]; rearSize = 3}));*)
(*  "back larger"           >::          (fun _ -> assert_equal {front = [7; 6; 5; 4; 3; 2; 1]; frontSize = 7; rear = []; rearSize = 0}*)
(*                                                              (check {front = [3; 2; 1]; frontSize = 3; rear = [4; 5; 6; 7]; rearSize = 4}));*)
]
